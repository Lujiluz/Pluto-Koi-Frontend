...
export default function AuctionSectionClient({ initialData }: AuctionSectionClientProps) {
  ...
  if (isLoading) {
    return (
      <>
        {/* Active Event Banner - Show even during loading */}
        <ActiveEventBanner />

        <section className="section-padding bg-white mx-8" id="lelang">
          <div className="container-custom">
            {/* General Rules Section - Show even during loading */}
            <GeneralRulesSection />
  ...
  if (isError) {
    return (
      <>
        {/* Active Event Banner - Show even during error */}
        <ActiveEventBanner />

        <section className="section-padding bg-white mx-8" id="lelang">
          <div className="container-custom">
            {/* General Rules Section - Show even during error */}
            <GeneralRulesSection />
  ...
  if (!data || allAuctions.length === 0) {
    return (
      <>
        {/* Active Event Banner - Show even when no data */}
        <ActiveEventBanner />

        <section className="section-padding bg-white mx-8" id="lelang">
          <div className="container-custom">
            {/* General Rules Section - Show even when no data */}
            <GeneralRulesSection />
  ...
  return (
    <>
      {/* Active Event Banner - Sticky with navbar */}
      <ActiveEventBanner />

      <section className="section-padding bg-white mx-8" id="lelang">
        <div className="container-custom">
          {/* General Rules Section - At the very top */}
          <GeneralRulesSection />
